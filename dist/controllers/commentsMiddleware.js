...
const getCommentsByBook = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const comments = yield CommentQueries.getCommentsByBook(req.query.book_name.toString());
        if (comments) {
            res.status(200).json({
                comments
            });
...
const updateComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const public_ip = req.socket.remoteAddress;
        const comment_date = new Date().toUTCString();
        const result = yield CommentQueries.updateComment(Object.assign(Object.assign({}, req.body), { public_ip, comment_date, id: req.params.id }));
        if (result) {
            res.status(200).json({
...
const addComment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const public_ip = req.socket.remoteAddress;
        const comment_date = new Date().toUTCString();
        const result = yield CommentQueries.addComment(Object.assign(Object.assign({}, req.body), { public_ip, comment_date }));
        if (result) {
            res.status(200).json({
